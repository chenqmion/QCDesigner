...
def new_device(zone=(22, 10),
               island_width=[0.3, 0.3],
               island_gap=[0.3],
               with_absorber=False,
               contact_gap=0.5, protection_gap=1.5,
               nanowire_width=0.1, nanowire_extension=1,
               ghost=[0.2, 0.8],
               w_electrode=3):
    probe = device()
    ...
    JJ_1 = sns.new_device(zone=zone,
                          island_width=island_width, island_gap=island_gap,
                          contact_gap=contact_gap, protection_gap=protection_gap, with_absorber=with_absorber,
...
chip_1 = chip(name=device_name,
              ...
              chip_size=(10e3, 10e3),
              trap_size=(20, 100))
chip_1.combine_device(x, ref=5e3 * (1 + 1j), degree=0, axis='none', port='center')
