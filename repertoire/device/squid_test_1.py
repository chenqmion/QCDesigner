...
def new_device(zone=(10, 10), squid_height=2, squid_width=6,
    ...
    JJ_1 = SQUID.new_device(zone=zone, squid_height=squid_height, squid_width=squid_width,
...
chip_1 = chip(name='SQUID_test',
              time='250711',
              logo='QCD',
              die_size=(15e3, 15e3),
              chip_size=(10e3, 10e3),
              trap_size=(20, 100))
chip_1.add_device('SQUID_test', x, ref=5e3 * (1 + 1j), degree=0, axis='none', port='center')
